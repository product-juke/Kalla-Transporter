...
class MartRevenueSmry(models.Model):
    _name = 'mart.revenue.smry'
    _description = 'Mart Revenue Summary'
    ...
    origin_name = fields.Char(string='ORIGIN', required=True)
    destination_name = fields.Char(string='DESTINATION', required=True)
    ...
    #         _logger.info(f"Inserted {len(mart_data)} records into mart.revenue.smry")
    #
