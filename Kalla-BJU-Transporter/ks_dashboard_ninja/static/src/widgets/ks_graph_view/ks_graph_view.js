        ...
        if (ks_data.length && ks_labels.length){
            ...
            for (let k = 0;k<ks_data.length ; k++){
                ...
                if (self.props.record.data.ks_show_data_value == true && series){
                    let label_text = self.props.record?.data.ks_data_format === "exact" ? "{valueY.formatNumber('0.00')}" : "{valueY}"
...
//                            locationY:1,
    ...
    //                        width: am5.percent(80-(10*k)),
                    ...
                    if (self.props.record.data.ks_show_data_value == true && series){
                        let label_text = self.props.record.data.ks_data_format === "exact" ? "{valueX.formatNumber('0.00')}" : "{valueX}"
                        series.bullets.push(function () {
                            return am5.Bullet.new(self.root, {
    //                            locationX: 1,
                                    sprite: am5.Label.new(self.root, {
            ...
            if(this.props.record.data.zoom_enabled){
                ...
                for (let k = 0;k<ks_data.length ; k++){
                    ...
                    if (self.props.record.data.ks_show_data_value == true && series){
                        var label_format_text = self.props.record.data.ks_show_data_value === "exact" ? "{valueY.formatNumber('0.00')}" : "{valueY}";
                        series.bullets.push(function () {
                            return am5.Bullet.new(self.root, {
                                sprite: am5.Label.new(self.root, {
