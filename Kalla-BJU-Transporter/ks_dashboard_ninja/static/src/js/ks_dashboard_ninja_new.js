...
//            var filter_date_data = null
            if (filter_date_data != null && !isMobileOS()){
...
//
//            if(this.state.ksDateFilterStartDate && this.state.ksDateFilterEndDate){
//                $('.ks_date_input_fields').addClass("ks_hide");
//                $('.custom-date-range-selector').removeClass("ks_hide");
//            }
            ...
            if(this.ks_dashboard_data.ks_date_filter_selection === 'l_custom'){
                $(this.header.el).find('.ks_date_input_fields').addClass("ks_hide");
...
//                    dnNavBarAddClasses();
    ...
    willStart(){
        var self = this;
//        if(isMobileOS()){
//            delete this.ks_date_filter_selections.l_custom
//        }
        var def;
...
//                            self.ks_dashboard_data = self.props.action.params.dashboard_data
//                        }
                    });
            });
        });
...
//        $(self.header.el).find(".clear-dashboard-date-filter").removeClass("ks_hide");
    ...
    _onKsApplyDateFilter(e) {
        ...
        if (start_date === "Invalid date") {
            ...
            $(self.header.el).find(".filters_section").removeClass("ks_hide");
            $(self.header.el).find(".ks_dashboard_top_settings").removeClass("d-none");
            self.state.ksDateFilterSelection = $(self.header.el).find('.ks_date_filter_selected').attr('id') || "none";
            self.state.pre_defined_filter = {}
            self.state.custom_filter = {}
        } else {
...
//                    var end_date = formatDateTime(end_date, self.datetime_format).format("YYYY-MM-DD H:m:s");
                ...
                this.notification.add(_t("Please enter end date."), {
                    type: "warning",
                });
            }
            else if (!start_date){
                this.notification.add(_t("Please enter start date."), {
                    type: "warning",
                });
            }
        }
...
//            this.ks_dashboard_data.ks_selected_board_id = layout_id;
    ...
    _onKsSaveLayoutClick(){
        ...
        $(self.header.el).find(".filters_section").removeClass("ks_hide");
         ...
         $(self.header.el).find(".ks_date_input_fields").removeClass("d-none");
    ...
    onKsEditLayoutClick(e) {
        var self = this;
        $(self.header.el).find(".ks_date_input_fields").addClass("d-none");
