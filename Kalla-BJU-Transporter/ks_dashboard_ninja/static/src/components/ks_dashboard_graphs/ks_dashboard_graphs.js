/** @odoo-module **/
import { Component, onWillStart, useState ,useEffect,onMounted, onPatched, onWillUpdateProps,useRef, onWillUnmount, markup } from "@odoo/owl";
            ...
            if ($(evt.target).parent().data().last_seq !== sequence) {
                self._rpc("/web/dataset/call_kw/ks_dashboard_ninja.item/ks_fetch_drill_down_data",{
                    ...
                    if (result.ks_list_view_data) {
                        ...
                        list_view_data,item_id:self.item_id,self, markup
                        })
